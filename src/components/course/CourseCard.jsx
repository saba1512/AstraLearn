  ...
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <h3 className="mt-5 text-2xl font-black text-slate-950">{course.title}</h3>
        <p className="mt-3 flex-1 text-sm leading-7 text-slate-600">{course.summary}</p>
        <div className="mt-4">
        ...
        <Link
          ...
          className="mt-6 inline-flex items-center justify-between rounded-lg bg-blue-600 px-4 py-3 font-bold text-white transition hover:bg-blue-700"
        >
          {actionLabel}
          <ArrowRight size={18} />
        </Link>
